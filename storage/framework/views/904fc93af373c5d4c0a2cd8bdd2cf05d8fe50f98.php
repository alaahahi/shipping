<!DOCTYPE >
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" html style="direction: rtl;">
    <head>
        <meta charset="utf-8">
    ...
    <body class="font-sans antialiased">
        ...
        <script>
            (function() {
                ...
                const connectionInfo = <?php echo json_encode($connection ?? [
                    'online_url' => config('app.url') . '/dashboard', 'local_url' => rtrim(config('app.url'), '/') . '/'
                ]) ?>;
...
<?php /**PATH C:\xampp\htdocs\shipping\resources\views/app.blade.php ENDPATH**/ ?>