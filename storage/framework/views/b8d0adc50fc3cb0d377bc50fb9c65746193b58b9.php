...
<body style="direction: rtl;"> 
  <?php if($config['second_title_ar']=='عين دبي'): ?>
  ...
  <div class="content">
    <div class="qr-header">
      <div class="info-item">
        ...
        <span class="value"><?php echo e($data['id'] ?? ''); ?></span>
      </div>
      ...
      <div class="info-item">
        ...
        <span class="value"><?php echo e($data['created'] ?? ''); ?></span>
      </div>
    </div>

    <?php if(!empty($isExternalContract)): ?>
    <div style="text-align:center;font-weight:700;font-size:14px;padding:6px 12px;margin-bottom:8px;border:1px solid #c00;border-radius:8px;background:#fff;">
      <?php echo e($contractTitleKu); ?> — <?php echo e($contractTitleAr); ?>
      ...
      <div class="party-card">
        ...
        <div class="party-card__body">
          <div class="info-row">
            ...
            <span class="value"><?php echo e($data['name_seller'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">دانیشتوی / السكن</span>
            <span class="value"><?php echo e($data['address_seller'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">رقم الموبايل</span>
            <span class="value"><?php echo e($data['phone_seller'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">رقم الهوية</span>
            <span class="value"><?php echo e($data['seller_id_number'] ?? ''); ?></span>
          </div>
        </div>
      </div>
      <div class="party-card">
        ...
        <div class="party-card__body">
          <div class="info-row">
            ...
            <span class="value"><?php echo e($data['name_buyer'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">دانیشتوی / السكن</span>
            <span class="value"><?php echo e($data['address_buyer'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">رقم الموبايل</span>
            <span class="value"><?php echo e($data['phone_buyer'] ?? ''); ?></span>
          </div>
          <div class="info-row">
            <span class="label">رقم الهوية</span>
            <span class="value"><?php echo e($data['buyer_id_number'] ?? ''); ?></span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div style="font-size: 13px;padding: 0 50px">
      <div>
        ...
        :
        <b class="px-3">
          <?php echo e(strtoupper((string) ($data['no'] ?? ''))); ?>
        ...
        (من النوع )
          :
          <b class="px-3">
            <?php echo e($data['car_name'] ?? ''); ?>

          </b>
          مودیل
          :
          <b class="px-3">
            <?php echo e($data['modal'] ?? ''); ?>
        ...
        <div class="pt-2">
          ...
          <b class="px-3 fs-6">
            <?php echo e(number_format($priceVal)); ?><?php echo e($priceSym); ?>

          </b>
          <?php echo e($Help->numberToWords($priceVal, $wordsCurrency)); ?>
        ...
        <div class="pt-2">
          ...
          (وقد قبض)
            :
          <b class="px-3 fs-6">
            <?php echo e(number_format($paidVal)); ?><?php echo e($priceSym); ?>

          </b>
          <?php echo e($Help->numberToWords($paidVal, $wordsCurrency)); ?>
        ...
        <div class="pt-2">
          ...
          (الباقی)
            :
          <b class="px-3 fs-6">
            <?php echo e(number_format($remainVal)); ?><?php echo e($priceSym); ?>

          </b>
          <?php echo e($Help->numberToWords($remainVal, $wordsCurrency)); ?>

        </div>
      </div>
      <?php if(!empty($data['vin_s'])): ?>
      <div>
        <div class="pt-3">
        2.
        ...
        :
        <b class="px-3">
          <?php echo e(strtoupper((string) ($data['no_s'] ?? ''))); ?>
        ...
        (من النوع )
          :
          <b class="px-3">
            <?php echo e($data['car_name_s'] ?? ''); ?>

          </b>
          مودیل
          :
          <b class="px-3">
            <?php echo e($data['modal_s'] ?? ''); ?>
          ...
          :
          <b class="px-3">
            <?php echo e($data['size_s'] ?? ''); ?>

          </b>
          رەنگ 
          (اللون) : 
          <b class="px-3">
            <?php echo e($data['color_s'] ?? ''); ?>
    ...
    ?>
    <?php if(!empty($contractTerms) && count($contractTerms) > 0): ?>
       ...
       <ul class="terms-list" style="counter-reset: term 2;">
        ...
        <li>
          تم إنشاء هذا العقد بتاريخ <?php echo e($data['created'] ?? ''); ?> في الساعة <?php echo e(\Carbon\Carbon::now()->format('H:i')); ?>
      ...
      <div class="d-flex justify-content-between  mt-2">
        <div class="text-center" style="width: 184px">
          <b>
            <?php echo e($data['name_seller'] ??''); ?>

          </b>
        </div>
        <div class="text-center" style="width: 184px">
          <b>
            <?php echo e($contractOrganizer ?? 'كاتب المعرض'); ?>

          </b>
        </div>
        <div class="text-center" style="width: 184px">
          <b>
            <?php echo e($data['name_buyer'] ??''); ?>
...
<script>
    $(document).ready(function() {
        const verificationUrl = <?php echo json_encode($verificationUrl ?? '', 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\shipping\resources\views/receiptContract.blade.php ENDPATH**/ ?>