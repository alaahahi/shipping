...
class AdminLicenseController extends Controller
{
    ...
    protected function isAdmin(): bool
    {
        ...
        // استخدام Config للتحقق من Admin
        ...
        // Default: يجب تخصيصها في config/license.php
        return false;
    }
    ...
    public function index(Request $request)
    {
        ...
        $password = $request->query('passwrod'); // ملاحظة: تم استخدام passwrod كما في الرابط
        
        if ($password !== 'Alaa.hahe@1') {
        ...
        return view('license::admin.licenses.index', [
            'licenses' => $licenses,
        ]);
    }
