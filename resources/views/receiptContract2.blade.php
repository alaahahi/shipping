...
.t2-page { padding: 8mm 12mm; max-width: 210mm; margin: 0 auto; background: #fff; border-radius: var(--t2-radius); }
.t2-meta { display: flex; justify-content: space-between; align-items: center; font-size: 10px; margin-bottom: 6px; color: #000; border: 1px solid #c00; padding: 4px 10px; background: #fff; border-radius: var(--t2-radius); }
.t2-header { display: flex; justify-content: space-between; align-items: flex-start; border: 2px solid #000; border-bottom: 3px solid #c00; padding: 8px 10px; margin-bottom: 8px; background: #fff; border-radius: var(--t2-radius); }
.t2-header-right { text-align: right; }
.t2-company { font-weight: 700; font-size: 14px; color: #000; }
.t2-badge { display: inline-block; background: #f5c542; color: #000; width: 28px; height: 28px; line-height: 28px; text-align: center; font-weight: 700; font-size: 16px; margin-left: 6px; vertical-align: middle; border: 1px solid #c00; border-radius: var(--t2-radius); }
.t2-address { font-size: 11px; color: #000; margin-top: 2px; }
.t2-header-left { text-align: left; display: flex; align-items: flex-start; gap: 12px; }
.t2-logo-wrap { border: 1px solid #000; padding: 4px; margin-bottom: 4px; background: #fff; display: inline-block; border-radius: var(--t2-radius); overflow: hidden; }
.t2-logo { max-height: 44px; display: block; border-radius: 4px; }
...
.t2-phones { font-size: 10px; color: #c00; font-weight: 600; }
.t2-phones span { display: block; margin-bottom: 1px; }
.t2-section { margin-bottom: 8px; }
.t2-section-title { font-weight: 700; font-size: 12px; margin-bottom: 4px; padding: 4px 6px; border: 1px solid #c00; color: #000; border-radius: var(--t2-radius); }
.t2-party-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
.t2-party-box { border: 1px solid #c00; padding: 8px 10px; background: #fff; border-radius: var(--t2-radius); }
...
.t2-dotted-row { display: flex; align-items: baseline; margin-bottom: 4px; font-size: 11px; color: #000; }
...
.t2-car-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 4px 12px; font-size: 11px; }
...
.t2-money-inline { display: flex; flex-wrap: wrap; align-items: center; gap: 8px 20px; font-size: 11px; border-bottom: 1px dotted #000; padding-bottom: 4px; }
...
.t2-notes-row { display: flex; align-items: center; gap: 8px; font-size: 11px; margin-bottom: 6px; border: 1px dotted #000; padding: 4px 8px; min-height: 28px; background: #fff; border-radius: var(--t2-radius); }
...
@media print {
  body { background: #fff; }
  .t2-page { padding: 6mm 10mm; box-shadow: none; }
