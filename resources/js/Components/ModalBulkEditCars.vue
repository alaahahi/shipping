...
function addSelectedTag() {
  ...
  if (!formData.value.tags.includes(idVal)) {
    formData.value.tags.push(idVal);
  }
...
function removeTag(tagValue) {
  ...
  ensureTagsArray();
  formData.value.tags = formData.value.tags.filter((t) => t !== tagValue);
}
      ...
      <div class="modal-wrapper max-h-[80vh]">
        <div class="modal-container dark:bg-gray-900 overflow-auto max-h-[80vh]">
          ...
          <div class="modal-body">
            ...
            <div className="mb-4 mx-1">
              <label class="dark:text-gray-200" for="bulk_car_tags">
