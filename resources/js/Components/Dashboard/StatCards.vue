...
const props = defineProps({
  ...
  totalPaymentsAndDebt: {
    type: Number,
    default: 0,
  },
  salesVsPaymentsDifference: {
    type: Number,
    default: 0,
  },
      ...
      <div class="flex items-center">
        ...
        <div class="ml-5 w-0 flex-1">
          <dl>
            ...
            <dd class="text-lg font-semibold text-teal-600 dark:text-teal-400">
              {{ formatNumber(tradersPayments) }}
            </dd>
          </dl>
        </div>
      </div>
      ...
      <div class="flex items-center">
        ...
        <div class="ml-5 w-0 flex-1">
          <dl>
            ...
            <dd class="text-lg font-semibold text-cyan-600 dark:text-cyan-400">
              {{ formatNumber(totalPaymentsAndDebt) }}
            </dd>
          </dl>
        </div>
      </div>
