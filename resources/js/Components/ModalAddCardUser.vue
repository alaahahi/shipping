          ...
          <div class="modal-container dark:bg-gray-900 overflow-auto  max-h-[80vh]">
            ...
            <div class="modal-body">
                        ...
                        <div className="mb-4 mx-5">
                          <label  class="dark:text-gray-200" for="card_id" > نوع البطاقة</label>
                          <select
                        ...
                        <div className="mb-4 mx-5">
                        <label  class="dark:text-gray-200" for="card" >عدد البطاقة التي تم تسليمها للمندوب</label>
                        <input
                          id="card"
                          type="number"
            ...
            <div class="modal-footer my-2">
              ...
              <div class="basis-1/2 px-4">
                <button class="modal-default-button py-3  bg-rose-500 rounded col-6"  @click="$emit('a',form);" :disabled="!(form.card && form.card_id)">{{ $t('yes') }}</button>
                </div>
