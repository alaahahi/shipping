        ...
        <div class="modal-wrapper  max-h-[80vh]">
          <div class="modal-container dark:bg-gray-900 overflow-auto  max-h-[80vh]">
            ...
            <div class="modal-body">
              <h2 class="text-center dark:text-gray-200">
                {{ $t('addCompanyName') }}
                      ...
                      <div className="mb-4 mx-5">
                        <label  class="dark:text-gray-200" for="name" >{{ $t('english_name') }}</label>
                        <input
                          id="name"
                          type="text"
                          class="mt-1 block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm dark:bg-gray-700 dark:text-gray-200 dark:border-gray-900 "
            ...
            <div class="modal-footer my-2">
              ...
              <div class="basis-1/2 px-4">
                <button class="modal-default-button py-3  bg-rose-500 rounded col-6"  @click="$emit('a',formData);formData.company_id='';formData.name='';formData.name_en='';formData.id=''" :disabled="!(formData.company_id && formData.name)">{{ $t('yes') }}</button>
                </div>
