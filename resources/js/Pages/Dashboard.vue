...
const message = `السلام عليكم: ${props.company_name || 'شركة سلام جلال أيوب'} - أربيل، يرجى تسديد حسابكم لدينا الخاص بالنقل والجمرك بشكل فوري. في حال عدم السداد، لن يتم إعادة فرق سعر الدولار مقابل الدينار دون أي استثناء. كما نود التنويه بأنه لا يمكن عمل خروجية لأي سيارة في حال وجود أي دين مستحق. شكراً لتعاونكم.

سڵاوی خواثان لێبێت: ${props.company_name || 'کۆمپانیای سلام جلال أيوب'} - هەولێر، تکایە بەزووترین کات حسابەکەتان بۆ گواستنەوە و گمرک بدەنەوە. لە حاڵەتی نەدان، هیچ جیاوازی نرخی دۆلار بەرامبەر دینار ناگەڕێندرێتەوە بە هیچ شێوەیەک. هەروەها ئاگاداری دەکرێنەوە کە ناتوانرێت خۆروجی بۆ هیچ ئۆتۆمبێلێک بکرێت ئەگەر قەرزێک هەبێت. سوپاس بۆ هاوکاری و تێگەیشتن`;
  ...
  const sendWhatsAppMessageArray = (array) => {
    ...
    const textMessage = `السلام عليكم: ${props.company_name || 'شركة سلام جلال أيوب'} - أربيل، يرجى الأخذ بالعلم تسديد المبلغ المستحق عليكم في أقرب وقت ممكن. في حال التأخير بالسداد لأكثر من أسبوع من تاريخ وصول السيارة، لا يتم حساب الجمرك على سعر 130000. شكرا لتعاونكم .......... سڵاوی خواثان لێبێت: ${props.company_name || 'کۆمپانیای سلام جلال أيوب'} - هەولێر، تکایە ئاگاداربن بە زووترین کات ئەو بڕە پارەیەی کە قەرزارن بیدەن. ئەگەر دەرەنجامی داواکاری پارەدان زیاتر لە هەفتەیەک پاش گەیشتنی ئۆتۆمبێل بێت، گمرک لەسەر نرخی 130000 ناژمێرێت. سوپاس بۆ هەماهەنگیت`;
