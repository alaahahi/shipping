              ...
              <table class="w-full my-5">
                ...
                >
                  <tr class="bg-rose-500 rounded-l-lg mb-2 sm:mb-0">
                    ...
                    <th className="px-4 py-2 border dark:border-gray-900" v-if="$page.props.auth.user.type_id!=2">تنفيذ</th>     
                  </tr>
                </thead>
                <tbody>
                  <tr
                  ...
                  <td className="border px-2 py-2 dark:border-gray-900"  v-if="$page.props.auth.user.type_id!=2">
                  <a 
                    tabIndex="-1"
